...
class Command(BaseCommand):
    help = 'Создает тестовые данные для мебельной фабрики'
    ...
    def handle(self, *args, **options):
        ...
        if created:
            ...
            self.stdout.write(f'Создан заказ: {order1.title}')
        ...
        if created:
            ...
            self.stdout.write(f'Создан заказ: {order2.title}')
        ...
        if created:
            ...
            self.stdout.write(f'Создан заказ: {order3.title}')
        ...
        if created:
            ...
            self.stdout.write(f'Создан заказ: {order4.title}')
        ...
        if order1.status == 'in_progress':
            ...
            if created:
                ...
                self.stdout.write(f'Создана запись в журнале: {journal1}')
        ...
        if order4.status == 'in_progress':
            ...
            if created:
                ...
                self.stdout.write(f'Создана запись в журнале: {journal2}')

        self.stdout.write(self.style.SUCCESS('\nТестовые данные успешно созданы!'))
        self.stdout.write(f'Всего типов мебели: {FurnitureType.objects.count()}')
        self.stdout.write(f'Всего цехов: {Workshop.objects.count()}')
        self.stdout.write(f'Всего рабочих: {Worker.objects.count()}')
        self.stdout.write(f'Всего заказов: {Order.objects.count()}')
        self.stdout.write(f'Всего записей в журнале: {OrderWorkJournal.objects.count()}')
